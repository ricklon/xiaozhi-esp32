...
// Sense camera connector (sensor must be confirmed) — XIAO ESP32-S3 Sense built-in pinout
...
#define SERVO_I2C_SDA_PIN GPIO_NUM_5
#define SERVO_I2C_SCL_PIN GPIO_NUM_6
#define SERVO_OE_PIN GPIO_NUM_9
