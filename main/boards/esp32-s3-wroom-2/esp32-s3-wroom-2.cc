...
#define TAG "Esp32S3Wroom2Board"

class Esp32S3Wroom2Board : public WifiBoard {
private:
    Button boot_button_;
...
public:
    Esp32S3Wroom2Board() : boot_button_(BOOT_BUTTON_GPIO) {
...
DECLARE_BOARD(Esp32S3Wroom2Board);
